...
#define STRING_CONFIG_H_AUTHOR "(AMU, Sprite-cr-touch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 V2 Sprite"
...
#define PROBING_MARGIN 30 // there is big fan in front of sprite pro. This avoids the front bed clips during probing.
